...
def get_db():
    ...
    if db is None:
        ...
        maxPoolSize=50, w="majority", wtimeout=2500
        )["mflix"]
    return db
...
def get_movies_by_country(countries):
    ...
    try:
        ...
        # return list(db.movies.find({'countries':{'in':countries}},{'title':1, _id:0}))
        #return db.movies.find({'countries':{'$in':{countries}},{'title':1}})
